...
export data_dir=$ROOT/datasets/jpner_1128_split #19_split
export label_file=label_invoice_ner.txt
export SAVE_STEPS=5000

export NUM_EPOCHS=200
export OUTPUT_DIR=$ROOT/ner/results/jpner_test_1203
...
--cache_dir $cache_dir \
--model_name_or_path $ROOT/ner/results/jpner_test_1128_e200 \
